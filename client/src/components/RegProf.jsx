...
const RegProf = ({ setRegModalOpen }) => {
  ...
  const [LogProfModalOpen, setLogProfModalOpen] = useState(false);
    ...
    <div className="regprof-wrapper">
      <div className="prof-reg-modal">
        <div className="form-box">
          <button onClick={() => setRegModalOpen(false)} id="form-close-btn">
            x
          </button>
          ...
          <div className="form-wrapper">
            ...
            <h6>Already have an account ?
              <Link onClick={() => setLogProfModalOpen(true)}>Logging</Link></h6>

            {LogProfModalOpen ? (
              <LogProf
                LogProfModalOpen={LogProfModalOpen}
                setLogProfModalOpen={setLogProfModalOpen}
              />
            ) : (
              ""
            )}
