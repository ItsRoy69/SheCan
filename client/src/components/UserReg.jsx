...
const UserReg = ({ setUserRegModalOpen }) => {
  ...
  const [UserLogModalOpen, setUserLogModalOpen] = useState(false);
        ...
        <div className="form-box">
          ...
          <div className="form-wrapper">
            ...
            <h6>
              ...
              <Link onClick={() => setUserLogModalOpen(true)}>Logging</Link>
            </h6>

            {UserLogModalOpen ? (
              <UserLog
                UserLogModalOpen={UserLogModalOpen}
                setUserLogModalOpen={setUserLogModalOpen}
              />
            ) : (
              ""
            )}
