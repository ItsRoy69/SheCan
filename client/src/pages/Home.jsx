...
import img2 from "../images/cline.jpg"
      ...
      <div className="home-bod-second">
        ...
        <div className="hss">
            <div className="hss-card">
                <img src="https://images.pexels.com/photos/5910953/pexels-photo-5910953.jpeg" alt="" />
                <p className="bl1"><b>Pharmacies, Clinics & Medical Supplies</b></p>
                <p className="bl"><b> Explore your needs</b>
               
                </p>
            </div>
            <div className="hss-card">
                <img src="http://whg-pc.com/wp-content/uploads/2020/07/shutterstock_780769447-1.jpg" alt="" />
                <p className="bl1"><b>Consult with doctors & gynecologists</b></p>
                <p className="bl"><b> Explore your needs</b>
               
                </p>
            </div>
            <div className="hss-card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQH_ef_tzmvgQwPFNAaV6kbFDcFnPKUXXtZwkfCqycwAZRxTOWS9iX4azlQuo16fLwWdAI&usqp=CAU" alt="" />
                <p className="bl1"><b>Education, Technology & Empowerment</b></p>
                <p className="bl"><b> Explore your needs</b>
